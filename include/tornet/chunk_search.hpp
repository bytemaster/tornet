#ifndef _TORNET_CHUNK_SEARCH_HPP_
#define _TORNET_CHUNK_SEARCH_HPP_
...
namespace tn {
  ...
  class chunk_search : public kad_search {
    public:
      typedef fc::shared_ptr<chunk_search> ptr;

      chunk_search( const node::ptr& local_node, const fc::sha1& target, 
      ...
      /**
       *  How many nodes have searched for, but not found this chunk.
       */
